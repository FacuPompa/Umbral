...
- Antes de diseñar o implementar, leer `docs/CONTEXTO-UMBRAL.md` y `docs/HANDOFF-UMBRAL.md`.
...
- Seguir `docs/FLUJO-DE-AGENTES.md` para coordinar tareas con Codex.
- Mantener un agente principal por recorrido vertical; los subagentes son apoyos temporales y solo se usan para investigación, revisión o verificación independientes.
- No ejecutar en paralelo agentes que modifiquen archivos del repositorio. El agente principal integra los resultados y es el único que propone el siguiente paso.
- Un subagente no amplía la autorización existente: respeta los mismos límites de edición, Git y acciones externas.
